            ...
            <div class="p-5 border-b border-[#153a2b] bg-[#071912] flex items-center space-x-3 flex-shrink-0">
                ...
                <nav class="mt-6 space-y-1.5 px-3 flex-1 overflow-y-auto custom-sidebar-scroll pb-6">
                    ...
                    <a href="{{ route('admin.leave-requests.index') }}"
                        class="flex items-center px-4 py-2.5 rounded-xl transition duration-150 text-sm font-semibold {{ request()->routeIs('admin.leave-requests*') ? 'sidebar-active' : 'text-gray-300 hover:bg-[#123b2c] hover:text-white' }}">
                    ...
                    <div>
                        <button @click="settingsOpen = !settingsOpen"
                            type="button"
                            class="w-full flex items-center justify-between px-4 py-2.5 rounded-xl transition duration-150 text-sm font-semibold {{ request()->routeIs('admin.settings*') ? 'sidebar-active' : 'text-gray-300 hover:bg-[#123b2c] hover:text-white' }}">
                            ...
                            <svg class="w-4 h-4 transition-transform duration-200" :class="settingsOpen ? 'rotate-180 text-[#d4af37]' : 'text-gray-400'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div x-show="settingsOpen" x-cloak x-transition.origin.top class="pl-6 pt-1.5 space-y-1">
                            <a href="{{ route('admin.settings.locations') }}" class="flex items-center px-3 py-2 rounded-lg text-xs font-semibold {{ request()->routeIs('admin.settings.locations*') ? 'text-[#d4af37] bg-[#123b2c]/60' : 'text-gray-300 hover:text-white hover:bg-[#123b2c]/40' }} transition">
                                <span class="mr-2.5 text-xs">📍</span> Lokasi & Radius
                            </a>
                            <a href="{{ route('admin.settings.schedules') }}" class="flex items-center px-3 py-2 rounded-lg text-xs font-semibold {{ request()->routeIs('admin.settings.schedules*') ? 'text-[#d4af37] bg-[#123b2c]/60' : 'text-gray-300 hover:text-white hover:bg-[#123b2c]/40' }} transition">
                                <span class="mr-2.5 text-xs">📅</span> Jadwal Kerja
                            </a>
                            <a href="{{ route('admin.settings.payroll') }}" class="flex items-center px-3 py-2 rounded-lg text-xs font-semibold {{ request()->routeIs('admin.settings.payroll*') ? 'text-[#d4af37] bg-[#123b2c]/60' : 'text-gray-300 hover:text-white hover:bg-[#123b2c]/40' }} transition">
